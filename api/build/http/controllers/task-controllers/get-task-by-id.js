...
var get_task_by_id_exports = {};
__export(get_task_by_id_exports, {
  getTaskById: () => getTaskById
});
module.exports = __toCommonJS(get_task_by_id_exports);
...
async function getTaskById(c) {
  const GetTaskByIdSchema = import_zod2.z.object({
